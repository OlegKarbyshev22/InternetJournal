    ...
    <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
        ...
        <form method="POST"  action="{{route('storeArticle')}}">
            ...
            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                ...
                <div class="w-full">
                    <label for="brand" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Slug статьи</label>
            ...
            <label class="block mb-2 mt-3 text-sm font-medium text-gray-900 dark:text-white" for="user_avatar">Превью статьи</label>
            <input name="thumbnail" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="user_avatar_help" id="user_avatar" type="file">
            ...
            <button type="submit" class="text-white mt-3 bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Добавить</button>
        </form>
    </div>
</section>
